...
2) Usage:
	...
	with # refers to a numerical value between 1-4 digits specifying the legsize, gauge and length of the item.
...
3) Notes:
	...
	ii) Warehouse - Each warehouse 001 and LVS produces boards of a different density. 
	    Thus selecting LVS warehouse applies an adustment factor to materials cost. Warehouse 001 is the default  
